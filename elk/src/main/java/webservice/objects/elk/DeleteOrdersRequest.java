 ...
 *       &lt;sequence>
 *         &lt;element name="elkOrderNumber" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DeleteOrdersRequest {
    ...
    protected List<String> elkOrderNumber;
     ...
     * This is why there is not a <CODE>set</CODE> method for the elkOrderNumber property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getElkOrderNumber().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getElkOrderNumber() {
        if (elkOrderNumber == null) {
            elkOrderNumber = new ArrayList<String>();
        }
        return this.elkOrderNumber;
    }
