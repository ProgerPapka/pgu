 ...
 *       &lt;sequence>
 *         &lt;element name="order" type="{http://gosuslugi.ru/lk/elk/types/}Order" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CreateOrders", propOrder = {
    "order"
})
public class CreateOrders {

    @XmlElement(required = true)
    protected List<CreateOrder> order;
     ...
     * 
     */
    public List<CreateOrder> getOrder() {
        if (order == null) {
            order = new ArrayList<CreateOrder>();
        }
        return this.order;
    }
